        ...
        foreach ($messages as $messageKey)
        {
            ...
            if($messageKey['addonName'] != 'Auto Login (SSO) using Kerberos/NTLM' && $messageKey['addonName'] != '') {
                ...
                if(!empty($messageKey['addonGuide'])) {echo'
                            <a class="dashicons mo-form-links dashicons-book-alt mo_book_icon" href='.esc_url($messageKey['addonGuide']).' title="Setup Guide" id="guideLink"  target="_blank" style="width:max-content;"><span class="link-text" style="color: black;">Setup Guide</span></a>
                            ';}echo'</div></center>';
            ...
            echo 'onclick="openSupportForm(\''.esc_attr($messageKey['addonName']).'\')"'. ' >Contact Us </a>
