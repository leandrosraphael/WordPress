...
function display_ldap_feedback_form()
{
    ...
    wp_enqueue_style('mo_ldap_admin_plugins_page_style', plugins_url('includes/css/mo_ldap_plugin_style_settings.min.css', __FILE__));
    ?>
    ...
    <div class="mo_ldap_modal_contatiner_feedback" style="color:black"></div>
        <div class="mo_ldap_modal_content_feedback" style="width:50%;">
            ...
            <form name="f" method="post" action="" id="mo_ldap_feedback">
                ...
                <div>
                    <h4 style="text-align:center;">Please help us to improve our plugin by giving your opinion.</h4>
                    <div id="smi_rate" style="text-align:center">
                        <input type="radio" name="rate" id="angry" value="1"/>
                        <label for="angry"><img class="sm" src="<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'includes/images/angry.png'); ?>" />
                        </label>

                        <input type="radio" name="rate" id="sad" value="2"/>
                        <label for="sad"><img class="sm" src="<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'includes/images/sad.png'); ?>" />
                        </label>


                        <input type="radio" name="rate" id="neutral" value="3"/>
                        <label for="neutral"><img class="sm" src="<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'includes/images/normal.png'); ?>" />
                        </label>

                        <input type="radio" name="rate" id="smile" value="4"/>
                        <label for="smile">
                            <img class="sm" src="<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'includes/images/smile.png'); ?>" />
                        </label>

                        <input type="radio" name="rate" id="happy" value="5" checked/>
                        <label for="happy"><img class="sm" src="<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'includes/images/happy.png'); ?>" />
                        </label>
                    ...
                    <div style="text-align:center;">
                        <div style="display:inline-block; width:60%;">
                            ...
                            <label for="edit"><img class="editable" src="<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'includes/images/61456.png'); ?>" />
                            </label>

                        </div>

                        <br><br>
                        <input type="checkbox" name="get_reply" value="YES" >Check this option if you want a miniOrange representative to contact you.<br><br> <b>On submitting the feedback your email address would be shared with the miniOrange team for contact purpose.</b></input>
                        <br><br>
