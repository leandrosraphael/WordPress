		...
		<div class="cd-pricing-container cd-has-margins" style="max-width: unset">
            ...
            function changePricing($this) {
                ...
                <div class="section-plans" id="section-plans" onmouseenter="onMouseEnterPlans()" onmouseleave="onMouseLeavePlans()"> 
                    ...
                    <input type="hidden" value="<?php echo esc_attr(Mo_Ldap_Local_Util::is_customer_registered()) ?>" id="mo_customer_registered">
                ...
                <div class="collapse" id="collapseExample" style="width:90%;">
                    <table class="FeatureList">
                        ...
                        <tr>
                            ...
                            <td class="features"><i class="fas fa-check"></i></td>
                            <td class="features"><i class="fas fa-check"></i></td>
                            <td class="features"><i class="fas fa-check"></i></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="features"><i class="fas fa-times" aria-hidden="true" style="color: red"></i></td>
                            <td class="features"><i class="fas fa-check"></i></td>
                            <td class="features"><i class="fas fa-check"></i></td>
                        </tr>
                        <tr>
                    ...
                    <div class="row">
                            <div class="col span-1-of-2 steps-box">
                                <div class="works-step">
                                    <div>1</div>
                                    <p>
                                        Click on Upgrade Now button for required premium plan and you will be redirected to <b> miniOrange login console.</b>
                                    </p>
                                </div>
                                <div class="works-step">
                                    <div>2</div>
                    ...
                    <section class="payment-methods">
                        ...
                        <div class="row">
                            <div class="col span-1-of-3">
                                <div class="plan-box">
                                    <div>
                                        <i style="font-size:50px;" class="fas fa-credit-card" aria-hidden="true"></i>
                                    </div>
                                    <div>
                            ...
                            <div class="col span-1-of-3">
                                <div class="plan-box">
                                    <div>
                                        <img class="payment-images" src="<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'includes/css/images/paypal.png'); ?>" alt="">
                                    </div>
                                    <div>
                                        Use the following PayPal ID <b>info@xecurify.com</b> for making the payment via PayPal.<br><br>
                                    </div>
                                </div>
                            </div>
                            <div class="col span-1-of-3">
                                <div class="plan-box">
                                    <div>
                                        <i style="font-size:30px;" class="fas fa-university" aria-hidden="true"><span style="font-size: 20px;font-weight:500;">&nbsp;&nbsp;Bank Transfer</span></i>
                                    </div>
                                    <div>
                        ...
                        <div class="row slideshow-container">
                            <div class="row review-slides1">
                                <div class="col span-1-of-3">
                                    ...
                                    <div class="row review-slides">
                                        <a class="button button-primary" target="_blank" href="https://wordpress.org/support/topic/the-best-plugin-for-ldap-ad-integration/">See Full Review</a>
                                    </div>
                                </div>
                                <div class="col span-1-of-3">
                                    <div class="row review-slides">
                                    ...
                                    <div class="row review-slides">
                                        <a class="button button-primary" target="_blank" href="https://wordpress.org/support/topic/great-functioning-great-support/">See Full Review</a>
                                    </div>
                                </div>
                                <div class="col span-1-of-3">
                                    <div class="row review-slides">
                                    ...
                                    <div class="row review-slides">
                                        <a class="button button-primary" target="_blank" href="https://wordpress.org/support/topic/ldap-for-intranet-microsoft-active-directory/">See Full Review</a>
                                    </div>
                                </div>
                            </div>
                            <div class="row review-slides1">
                                <div class="col span-1-of-3">
                                    ...
                                    <div class="row review-slides">
                                        <a class="button button-primary" target="_blank" href="https://wordpress.org/support/topic/easy-to-use-and-great-support-68/">See Full Review</a>
                                    </div>
                                </div>
                                <div class="col span-1-of-3">
                                    <div class="row review-slides">
                                    ...
                                    <div class="row review-slides">
                                        <a class="button button-primary" target="_blank" href="https://wordpress.org/support/topic/i-recommend-this-plugin-13/">See Full Review</a>
                                    </div>
                                </div>
                                <div class="col span-1-of-3">
                                    <div class="row review-slides">
                                    ...
                                    <div class="row review-slides">
                                        <a class="button button-primary" target="_blank" href="https://wordpress.org/support/topic/great-support-great-features-4/">See Full Review</a>
                                    </div>
                                </div>
                            </div>
                            <div class="row review-slides1">
                                <div class="col span-1-of-3">
                                    ...
                                    <div class="row review-slides">
                                        <a class="button button-primary" target="_blank" href="https://wordpress.org/support/topic/very-good-plugin-and-support-37/">See Full Review</a>
                                    </div>
                                </div>
                                <div class="col span-1-of-3">
                                    <div class="row review-slides">
                                    ...
                                    <div class="row review-slides">
                                        <a class="button button-primary" target="_blank" href="https://wordpress.org/support/topic/simply-perfect-104/">See Full Review</a>
                                    </div>
                                </div>
                                <div class="col span-1-of-3">
                                    <div class="row review-slides">
                                    ...
                                    <div class="row review-slides">
                                        <a class="button button-primary" target="_blank" href="https://wordpress.org/support/topic/great-plugin-great-support-1454/">See Full Review</a>
                                    </div>
                                </div>
                            </div>
