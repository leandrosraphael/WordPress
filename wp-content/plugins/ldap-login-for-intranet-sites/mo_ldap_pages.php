...
function mo_ldap_local_settings() {
    ...
    <?php
        ...
        <div style="font-size: large; font-weight: 600;"><br>miniOrange LDAP/Active Directory Login for Intranet Sites
            ...
            <button id="restart_plugin_tour" type="button" value="restart_plugin_tour" style="position: relative" class="button button-primary button-large"  onclick="jQuery('#restart_plugin_tour').val('true');jQuery('#show_ldap_pointers').submit();"><i class="fas fa-sync"></i> Take Plugin Tour</button>
            </span></div>
        <?php
    ...
    if (!Mo_Ldap_Local_Util::is_curl_installed()) {
        ...
        <div class="notice notice-error is-dismissible">
            <div id="help_curl_warning_title" class="mo_ldap_title_panel">
                <p><font color="#FF0000"><?php echo esc_attr($curl_warning); ?></font></p>
                <p><a target="_blank" style="cursor: pointer;">Click here for instructions to enable it.</a></p>
            </div>
            ...
            <form method="post" action="">
                ...
                <table cellpadding="4" cellspacing="4">
                    <tr>
                        ...
                        <td><input type="text" name="mo_ldap_demo_email" placeholder="We will use this email to setup the demo for you" required style="width:350px" value="<?php echo esc_attr($admin_email) ?>" <?php if(!Mo_Ldap_Local_Util::is_curl_installed()) echo "disabled";?>></td>
                    </tr>
        ...
        <div class="mo_ldap_table_layout" style="padding:0 20% 5% 20%;">
            ...
            <div class="mo_ldap_panel">
                ...
                <table class="mo_ldap_settings_table">
                    <tr>
                        <td style="font-size:16px;"><b><font color="#FF0000">*</font>Email:</b></td>
                        <td>
                            <?php
                            $current_user = wp_get_current_user();
                            if(get_option('mo_ldap_local_admin_email'))
                            ...
                            <input class="mo_ldap_table_textbox" type="email" name="email"
                                   ...
                                   value="<?php echo esc_attr($admin_email);?>" <?php if(!Mo_Ldap_Local_Util::is_curl_installed()) echo "disabled";?>/>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size:16px;"><b><font color="#FF0000">*</font>Password:</b></td>
                    ...
                    <tr>
                        <td style="font-size:16px;"><b><font color="#FF0000">*</font>Confirm Password:</b></td>
                        <td><input class="mo_ldap_table_textbox" required type="password"
...
function mo_ldap_local_configuration_page(){
    ...
    $mo_ldap_local_password_status = get_option( 'mo_ldap_local_password_status') ? get_option( 'mo_ldap_local_password_status') : "";
        ...
        elseif($mo_ldap_local_password_status == 'INVALID')
	...
	?>
		...
		<div class="mo_ldap_small_layout" style="margin-top:0px;">
            ...
            <button id="restart_tour" type="button" value="restart_tour" class="button button-primary button-large"  onclick="jQuery('#show_ldap_pointers').submit(); "><i class="fas fa-sync"></i>  Take Tour</button>
            </span>
                ...
                <p><strong style="font-size:14px;">NOTE: </strong> You need to find out the values for the below given fields from your LDAP Administrator.</strong></p>
					<table class="mo_ldap_settings_table">
						...
						<tr>
                            ...
                            <td style="float: left;width:78%;"><div id="mo_ldap_directory_server_url" style="position: relative;"><table style="width: 95%"><tr><td ><input class="mo_ldap_table_textbox <?php echo esc_attr($mo_ldap_local_server_url_status); ?>" type="text" id="ldap_server" name="ldap_server" style="width: 100%;margin-left: 7%" required placeholder="LDAP Server hostname or IP address" value="<?php echo esc_attr($ldap_server_address)?>" /></td><td></td></td></tr></table></div></td>
					...
					<table class="mo_ldap_settings_table">
						...
						<tr>
							...
							<?php if(get_option('mo_ldap_local_cust', '1') == '0'){ ?>
								<br><span style="color:#008000;"><b>Multiple Search Bases are supported in the <a href="<?php echo esc_url(add_query_arg( array('tab' => 'pricing'), $_SERVER['REQUEST_URI'] )); ?>">Premium Version</a> of the plugin.</b></span></i><br><br></td>
							<?php }else{ ?>
                        ...
                        <tr>
							...
							<table>
                                ...
                                <?php if(get_option('mo_ldap_local_cust', '1') == '0'){ ?>
                                <br><span style="color:#008000;"><b>Logging in with multiple attributes are supported in the <a href="<?php echo esc_url(add_query_arg( array('tab' => 'pricing'), $_SERVER['REQUEST_URI'] )); ?>">Premium Version</a> of the plugin.</b></span></i><br><br></td>
                            <?php }?>
							</ol>
						</tr>
			...
			<div class="mo_ldap_panel">
				<table class="mo_ldap_settings_table">
					...
					<tr>
						...
						<td><input class="mo_ldap_table_textbox <?php if(isset($_POST['test_username']))echo esc_attr($mo_ldap_local_password_status); ?>" type="password" name="test_password" required placeholder="Enter password" /></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
...
function mo_show_export_page(){
	?><div class="mo_ldap_support_layout">
		<div> <span id="export-config-service-restart-tour" style="position: relative; float:right; padding-bottom: 14px;padding-top:14px;background: white;border-radius: 10px;">
                        <button type="button"  class="button button-primary button-large"  onclick="jQuery('#show_ldap_pointers').submit();"><i class="fas fa-sync"></i>  Take Tour</button>
            </span><br>
 ...
 <div class="mo_ldap_small_layout" style="margin-top:0px;">
            ...
            <form name="f" id="enable_admin_wp_login" method="post" action="">
                ...
                <div id="miniorange-fallback-login" style="position:relative;background:white; line-height: 5;border-radius: 10px;">
                    <input type="checkbox" id="" name="" disabled /> Authenticate WP Users from both LDAP and WordPress <span style="color:#008000;"><b> <i>( Supported in <a href="<?php echo esc_url(add_query_arg( array('tab' => 'pricing'), $_SERVER['REQUEST_URI'] )); ?>">Premium Version</a> of the plugin. )</i></b></span>
                </div>
            </form>
            <br>
...
function mo_ldap_local_multiple_ldap(){
    ...
    <div style="position: relative;
        ...
        <h3 class="mo_ldap_left">Add new LDAP Server &nbsp<sup style="font-size: 12px;color: green;">[To get more details on this plan please <a name="MultipleDirContactUsTab" href="#MultipleDirContactUs">Contact Us</a> ]</sup></h3>
                 <table class="mo_ldap_settings_table">
                      <tr>
                            <td style="width: 24%"><b><font color="#FF0000">*</font>LDAP Server:</b></td>
    ...
    <div class="mo_ldap_small_layout" style="">
        ...
        <h3>LDAP Groups to WP User Role Mapping <sup style="font-size: 12px;color:#008000;">[Available in <a href="<?php echo esc_url(add_query_arg( array('tab' => 'pricing'), $_SERVER['REQUEST_URI'] )); ?>">Premium Version</a> of the plugin.]</sup></h3>
						...
						<tr>
							...
							<td><input class="mo_ldap_table_textbox" type="text" name="mapping_key_<?php echo esc_attr($i);?>"
							...
							<td>
								<select name="mapping_value_<?php echo esc_attr($i);?>" id="role" style="width:100%;background: #DCDAD1;"  >
						...
						<tr>
							...
							<td><div id="role_mapping_form_ldap" style="position: relative;line-height: 5;  ">
								  <?php
								   ...
								   ?>
								<input type="text" name="mapping_memberof_attribute" required="true" placeholder="Group Attributes Name" style="width:100%;background: #DCDAD1;" value="<?php echo esc_attr($mapping_memberof_attribute);?>"  >
							</div></td>
						</tr>
                            <tr>
		...
		<div class="mo_ldap_table_layout">
			...
			<form name="f" method="post" id="attribute_config_form">
				...
				<table id="attributes_table" class="mo_ldap_settings_table">
                    ...
                    <tr><td></td></tr><tr><td colspan="2"><span style="color:#008000;"><b><i>Support for Phone, First Name, Last Name and Custom attributes from LDAP is present in the <a href="<?php echo esc_url(add_query_arg( array('tab' => 'pricing'), $_SERVER['REQUEST_URI'] )); ?>">Premium Version</a> of the plugin.</i></b></span></i></td></tr>
                    <tr><td><br></td></tr>


                    <tr>
                        <td style="width:40%;"><b>Email Domain</b></td>
                        <td><div id="ldap_intranet_email_domain" style="position: relative;border-radius: 10px;"><input type="text"  name="mo_ldap_email_domain" placeholder="example.com"  style="width:80%;"
                                                                                                                               value="<?php echo esc_attr(get_option('mo_ldap_local_email_domain'));?>"/></div></td>
                    </tr>
                    <tr></tr>
                    <tr></tr>

                    <tr>
                        <td colspan=2><i>Set user's email to <b>username@email_domain</b> in WordPress, if the "mail" attribute is not set in LDAP directory.</i></td>
                    </tr>
							...
							if(get_option('mo_ldap_local_cust', '1') != '0'){
								...
								foreach($wp_options as $option=>$value){
									if(strpos($option, "mo_ldap_local_custom_attribute_") === false){
										...
										?><tr>
											<td><b><font color="#FF0000"></font><?php echo esc_attr($value); ?> Attribute</b></td>
												<td><b><?php echo esc_attr(get_option($option)); ?></b></td>
											<td><a style="cursor:pointer;" onclick="deleteAttribute('<?php echo esc_attr($value); ?>');">Delete</a></td>
										</tr><?php
									}
								}
							?>
