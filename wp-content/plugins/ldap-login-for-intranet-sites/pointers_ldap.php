...
if (get_option('overall_plugin_tour') && get_option('overall_plugin_tour')=='true') {
    ...
    $pointers['miniorange-add-on-tab'] = array(
        ...
        <br><br><b>1. Sync Users LDAP Directory</b>
        <br><b>2. Auto Login (SSO) using Kerberos/NTLM</b>
        <br><b>3. Password Sync with LDAP Server</b>
        <br><b>4. Profile Picture Sync for WordPress and BuddyPress</b>
        <br>and many more..."),
